        ...
        <div className="relative container-wide pt-12 sm:pt-16 pb-20 sm:pb-28">
          <div className="text-center max-w-3xl mx-auto stagger-children">
            ...
            <div className="grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto">
              ...
              <Link
                href="/sponsor"
                className="group bg-white p-7 rounded-2xl border border-slate-200 hover:border-[#2563EB]/30 transition-all duration-300 shadow-sm hover:shadow-lg text-left"
              >
                <div className="w-14 h-14 bg-[#2563EB] rounded-xl flex items-center justify-center mb-5 group-hover:scale-105 transition-transform shadow-md">
                ...
                <span className="inline-flex items-center gap-1.5 text-[#2563EB] font-medium text-sm group-hover:gap-2.5 transition-all">
                  Sponsor Demo
