            ...
            {populations.map((option, index) => (
              ...
              >
                <input
                  ...
                  className="w-4 h-4 mt-0.5 text-[#3B82F6] border-slate-300 bg-white focus:ring-[#3B82F6]"
                />
              ...
              .map((option) => (
                ...
                >
                  <input
                    ...
                    className="w-4 h-4 mt-0.5 text-[#3B82F6] border-slate-300 bg-white rounded focus:ring-[#3B82F6]"
                  />
                  <div className="flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="text-slate-900 font-medium">{option.name}</span>
            ...
            {DURATION_OPTIONS.map((option) => (
              ...
              >
                <input
                  ...
                  className="w-4 h-4 text-[#3B82F6] border-slate-300 bg-white focus:ring-[#3B82F6]"
                />
