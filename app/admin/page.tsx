      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">Demo controls and study management</p>
          </div>
          <button
            onClick={fetchData}
                ...
                <div key={study.id} className="p-6">
                  ...
                  {expandedStudy === study.id && (
                    <div className="mt-6 pt-6 border-t border-gray-100">
                      <h4 className="text-sm font-medium text-gray-700 mb-4">Participants</h4>
                      {getParticipantsForStudy(study.id).length === 0 ? (
                        <p className="text-sm text-gray-500">No participants enrolled yet.</p>
                      ) : (
                            ...
                            >
                              ...
                              <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-gray-200">
                                ...
                                <div className="relative inline-block">
                                  <select
                                    className="appearance-none bg-white border border-gray-200 rounded-lg px-3 py-2 pr-8 text-sm font-medium text-gray-700 hover:bg-gray-50 cursor-pointer"
                                    value=""
                                    onChange={(e) => {
                                      if (e.target.value) {
                                  ...
                                  <Clock className="w-4 h-4 absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400" />
                                </div>
