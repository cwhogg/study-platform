    ...
    <>
      <MobileFullScreen className="pb-32 bg-white">
        ...
        <div className="text-center pt-8 mb-8 stagger-children">
          {/* Logo/Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#1E3A5F]/10 border border-[#1E3A5F]/30 rounded-full mb-6">
            <div className="w-2 h-2 bg-[#1E3A5F] rounded-full animate-pulse" />
            <span className="text-xs font-medium text-[#1E3A5F]">Research Study</span>
          </div>
        ...
        <div className="space-y-4 stagger-children">
          {bullets.slice(0, 3).map((bullet, index) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-br from-[#1E3A5F] to-[#2a4a6f] rounded-xl flex items-center justify-center flex-shrink-0">
